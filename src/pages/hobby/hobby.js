          ...
          <div className="column is-3">
            <aside className="menu">
              <ul className="menu-list">
                <li><Link to="photography" className=""><Icon name="images" type="far" size="sm" title="Hobby" /> Photography</Link></li>
                <li><Link to="donations" className=""><Icon name="heart" type="fas" size="sm" title="Donations" /> Donations</Link></li>
              </ul>
            </aside>
          </div>
